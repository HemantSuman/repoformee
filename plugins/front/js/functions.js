...
function selectDropText() {
    ...
    $('.category-slider li a').on('click', function () {
        ...
        //$('.main-cat-dropdown').hide(); 


    });

    $('.sub-category-slider li a').on('click', function () {
        var grabText = $(this).text();
        var grabImg = $(this).find('img').attr('src');
...
/*Checkout Payment*/
// $(document).ready(function(){    
$('.payment-options ul li a').click(function () {
    $('.payment-options ul li a.active').removeClass('active');
    $(this).closest('.payment-options ul li a').addClass('active');
});
$('.via-credit').click(function () {
    $('.via-paypal-sec').hide();
    $('.via-credit-sec').show();
});
$('.via-paypal').click(function () {
    $('.via-paypal-sec').show();
    $('.via-credit-sec').hide();
});
//});
