...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li>
            <a href="{!! url('admin/classifieds/export-approve'); !!}" class="btn btn-info btn-lg">Export</a>
        </li>
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="custom-searchbar col-md-9 pull-right">
                        ...
                        {!! Form::open(array("url" => "admin/$viewName/approve", 'method'=>'post', "role" => "form", 'files' => true)) !!}	
...
<!--                        <div class="cst-search-category">
                        ...
                        <div class="cst-search-category">
                            {!! Form::submit('Search', ['class' => 'btn btn-primary']) !!} <a href='{{ url("/admin/$viewName/approve") }}' class="btn btn-primary">Reset</a>
                        </div>
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><span class="label label-<?php if ($val->status == 0) { ?>danger<?php } elseif ($val->status == 2){ ?>info<?php }else { ?>success<?php } ?>">
                                    @if($val->status==0) Inactive @elseif($val->status==2) UnApproved @else Active @endif</span>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a href='{{ url("/admin/$viewName/view",$val->id).'/approved' }}' class="btn btn-info" title="View and Approve"><i class="fa fa-eye"></i></a>
                                <a href="javascript:void(0)" onclick="deleteRecord('{{$val->id}}', 'approve', 'admin_delete', this,'')" class="btn btn-warning" title="Delete Record"><i class="fa fa-trash"></i></a>
                               </td>
