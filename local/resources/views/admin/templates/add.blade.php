            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('parent_categoryid', $categories, '', ['placeholder' => 'Select Category', 'class' => 'form-control parent_categoryid getChildCat']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id', [], '', ['placeholder' => 'Select Sub Category', 'class' => 'form-control getClassifiedList', 'id' => 'sub_categories1']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('classified_id', [], '', ['placeholder' => 'Select Products', 'class' => 'form-control classified_id']) !!}
                    ...
                    <div class="form-group com_info">
                        ...
                        {!! Form::select('discount_type', $discount_type, null, ['placeholder' => '-Select-','class' => 'form-control comm_details']) !!}
