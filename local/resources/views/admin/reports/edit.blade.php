    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::model($data, array('action' => ["$controllerName@admin_edit", $data->id], 'files' => true, 'class' => 'form-horizontal')) !!}
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                {!! Form::select('feed_category_id', $options, (!empty($data->feed_category_id)) ? $data->feed_category_id : null, array('class' => 'form-control', 'placeholder' => 'Select Category') ) !!}
