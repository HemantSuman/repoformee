                ...
                <div class="box-header">
                    ...
                    <div class="custom-searchbar col-md-9 pull-right">
                        ...
                        <div class="cst-search-category">
                            {!! Form::text('plan_name', (isset($result->form_request['plan_name']))?$result->form_request['plan_name']:'', ['placeholder' => 'Plan Name', 'class' => 'form-control']) !!}
                        </div>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td>{{ $val->id }}</td>
                                <td>{{ @ucfirst($val->plan_name) }}</td> 
                                <td>{{ @ucfirst($val->plan_type) }}</td> 
                                <td>{{ @ucfirst($val->membership_plan_roles->name) }}</td> 
                                <td>{{ @ucfirst($val->plan_price) }}</td> 
