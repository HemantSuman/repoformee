    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::open(array("url" => "admin/users/create_register_user", "role" => "form", 'class' => 'form-horizontal')) !!} 
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                 {!! Form::input('number', 'mobile_no', null, ['class' => 'form-control','placeholder'=>'mobile no','min'=>'0']) !!}
