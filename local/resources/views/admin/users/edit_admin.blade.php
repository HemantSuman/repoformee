    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
               ...
               {!! Form::model($user, array('action' => ["admin\UsersController@admin_update", $user->id],'class' => 'form-horizontal')) !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('role_id', $role, (!empty($user->role_id)) ? $user->role_id : null, array('class' => 'form-control', 'placeholder' => 'Select Role') ) !!}
