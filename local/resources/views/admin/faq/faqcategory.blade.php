            ...
            <div class="box">
                <div class="box-header">
                                        ...
                                        <h3 class="box-title">
                                               ...
                                               <a class="btn btn-block btn-primary" href="{{ url('/admin/addfaqcategory') }}"> Add Faq Category</a>
                                        </h3>
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{  $result->name }}</td>
                            <td>
                                <a href='{{ url("/admin/faq/edit",$result->id) }}' class="btn btn-info" title="Edit Record"><i class="fa fa-pencil"></i></a>
                                <a href="javascript:void(0)" onclick="deleteRecord('{{$result->id}}',  'faq','delete', this, 0)" class="btn btn-warning" title="Delete Record"><i class="fa fa-trash"></i></a>                                
                            </td>  
