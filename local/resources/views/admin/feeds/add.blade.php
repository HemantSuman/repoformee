                ...
                {!! Form::open(array("url" => "admin/$viewName/add", "role" => "form", 'class' => 'form-horizontal')) !!} 
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('feed_category_id', $feed_categories, null, array('class' => 'form-control', 'placeholder' => 'Select Category') ) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{!! old('news_type') !!}" name="news_type" class="form-control" placeholder="News type">
