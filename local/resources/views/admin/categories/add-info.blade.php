...
<!--                    <div class="form-group ">
                    ...
                    <div class="form-group com_info">
                       <!-- <label>Select Commounity & Information </label>         
                        ...
                        {!! Form::input('hidden', 'com_info', 0) !!}
                         {!! Form::input('hidden', 'show_on_info_area', 1) !!}
...
<!--                    <div class="checkbox bike-category">
                ...
                <div class="box-footer">
                    ...
                    @if($categoriesSelected)
                    <a style="margin-left: 5px;" class="btn btn-default btn-close" href='{!! url("admin/categories-info/$categoriesSelected->id"); !!}'>Cancel</a>
                    @else
