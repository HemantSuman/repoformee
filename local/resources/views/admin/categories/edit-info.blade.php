...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('/admin/categories-info') }}">{{$modelTitle}}</a></li>
    </ol>
</section>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                {!! Form::model($result, array('action' => ["admin\\$controllerName@admin_update_info", $result->id], 'files' => true)) !!}
...
<?php $disable2 = 'readonly'; ?>
                ...
                <div class="box-footer">
                    ...
                    @if($result->categoriesSelected)
                    <a style="margin-left: 5px;" class="btn btn-default btn-close" href='{!! url("admin/categories-info/$result->pid"); !!}'>Cancel</a>
                    @else
                    <a style="margin-left: 5px;" class="btn btn-default btn-close" href="{!! url('admin/categories-info'); !!}">Cancel</a>
                    @endif
                </div>
                {!! Form::close() !!}
            </div>
