                         ...
                         <div class="table-responsive">
                             <table class="table">
                                ...
                                @foreach($orderData as $key => $value)
                                	@foreach($value['order_detail'] as $keydt => $valuedt)
                                 <tr>
                                     <td><?php echo $value['id'];?></td>     
                                     <td><?php echo $valuedt['item_name'];?></td>
                                    
                                     <td>$<?php echo $valuedt['item_total_amt'];?></td>
                                     <td><?php //echo $valuedt['order_status'];?>
                                     <?php if($value['paypal_paykey'] != '' && $value['paypal_paykey'] != null){ 
									 echo 'PayPal';
									 }else{
										echo 'Pick n Pay'; 
									 }
                                     ...
                                     <td><a href="<?php echo URL('user/orders/view', ['id'=>$value['id'], 'subId'=>$valuedt['id']])?>">View</a> / <a href="<?php echo URL('user/orders/view', ['id'=>$value['id'], 'subId'=>$valuedt['id']])?>">Edit</a> 
