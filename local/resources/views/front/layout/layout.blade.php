...
<!--         <script type="text/javascript" src="{{  URL::asset('/plugins/front/js/front-main-functions.js') }}"></script>-->
    ...
    ?>">
        ...
        <header>
            <?php /*?>@if($controller == "ClassifiedController" && $action == "get_searchresult")
...
<!--        <script type="text/javascript" src="{{  URL::asset('/plugins/front/plugins/CustomFile/custom.js') }}"></script>-->
        ...
        <script type="text/javascript" src="{{ URL::asset('/plugins/front/js/jquery.accordion.js') }}"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.0.1/socket.io.js"></script>

        <script type="text/javascript" src="{{  URL::asset('/plugins/front/js/slick.js') }}"></script>
...
if (isset(Auth::guard("web")->user()->id)) {
    ...
    //                        } else
    //                        {
    //                            classifiedid_chat=$('.classifiedid_chat').val();
    //                            receiveruser_id=$('.receiveruser_id').val();
    //                            if (classifiedid_chat == data.classified_id && receiveruser_id == data.s_id)
    //                            {
    //                                var now = new Date(Date.now());
    //                                var formatted = now.getHours() + ":" + now.getMinutes();
    //                                var appendMsgToChat = "<div class = 'withiconmsg chatmsg'><div class ='icon'> <a href='#'> <img alt='' src='" + data.image + "' alt=''></a></div><div class='msgtxt'><p>" + data.msg + "</p></div><div class='chattime'><span>" + formatted + "</span></div></div>"
