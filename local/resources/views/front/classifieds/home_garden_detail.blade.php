  ...
  <div class="container">
    ...
    <div class="row">      
             ...
             <div class="preview-ad-thumbs">
               <div class="ad-large-thumb home-gardern-lg-thumb">
                  <section class="home-slider-for slider">
                    <div> 
                      <img src="{{ URL:: asset('/plugins/front/img/home-gardern1.jpg')}}" alt="img">
                    </div>
                    <div> 
                      <img src="{{ URL:: asset('/plugins/front/img/home-gardern1.jpg')}}" alt="img">
                    </div>
        ...
        <div class="col-sm-12 col-md-5">
          <h2 class="product-side-title">5-Speed Diamond Blender  <span>Kitchen Aid</span>  </h2>
           <ul class="real-view-icon-list product-view-list">
                   <li><a href="#"><img src="{{ URL:: asset('/plugins/front/img/view-icon.png')}}" alt="img"> <span>20</span> </a></li>
