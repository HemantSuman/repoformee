...
<div id="middle" class="no-banner">
    ...
    <div id="post-add">
        ...
        <ul class="nav nav-tabs hide" role="tablist" >
            <li role="presentation" class="active"><a class="tab1" href="#select_category1" aria-controls="select_category" role="tab" data-toggle="tab">Select Category</a></li>
            <li role="presentation"><a class="tab2" href="#select_sub_category1" aria-controls="select_sub_category" role="tab" data-toggle="tab">Select Subcategory</a></li>
            <li role="presentation"><a class="tab3" href="#post_classified1" aria-controls="post_classified" role="tab" data-toggle="tab">Post Classified</a></li> 
            <li role="presentation"><a class="tab4" href="#advert_preview1" aria-controls="advert_preview" role="tab" data-toggle="tab">Advert Preview</a></li>   
        </ul>
        ...
        <!-- Tab panes -->
        {!! Form::open(array("url" => "user/classifieds/business_create", "role" => "form", 'files' => true, 'id'=>'submitFrm')) !!} 
        <div class="tab-content">
            <input type="hidden" name="parent_categoryid" class="parent_categoryid" >
            <input type="hidden" name="category_id" class="category_id" >
            <input type="hidden" name="membership_plan_user_id" class="membership_plan_user_id" value="{{$memPlanUser[0]['id']}}" >
            <input type="hidden" name="is_premium_parent_cat" class="is_premium_parent_cat" value="{{$memPlanUser[0]['is_premium_parent_cat']}}" >
            <input type="hidden" name="is_premium_sub_cat" class="is_premium_sub_cat" value="{{$memPlanUser[0]['is_premium_sub_cat']}}" >
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="ad-category-top-text">
                                <p>We have recognised your subscription plan as <span>{{$memPlanUser[0]['plan_name']}}</span>. Below we have provide suitable categories related to your business. Please select your appropriate category and sub category, and start your ad posting.</p>
                            </div>
                        </div>                
                    </div> 
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="ad-category-box">
                                ...
                                <div class="sb-container ad-cat-scroll-sec">
                                    <ul class="ad-category-list">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" categoryId='{{$value['id']}}' class="parent_cat {{($loop->iteration == 1)? 'active' : ''}}" >
                                                <span class="ad-cat-icon"><img class="cat-icon" src="{{ URL::asset("upload_images/categories/icon/$value->id/$value->icon")}}" alt="img"></span>
                                                <span class="cat-name ad-cat-text">{{$value['name']}}</span>
                                            </a>
                                        </li>
                                        @endforeach
                                        @endif
                            ...
                            <div class="ad-category-box ad-subcategory-box">
                                <h2>Sub Category</h2> 
                                <div class="sb-container ad-cat-scroll-sec">
                                    <ul class="ad-category-list" id="sub-categories">
                                        @if(!empty($childCategory))
                                        @foreach($childCategory as $value)
                                        <li>
                                            <a href="javascript:void(0);" categoryId='{{$value['id']}}' p_id='{{$value['pid']}}' class="child_cat">
                                                <span class="ad-cat-icon"><img class="cat-icon" src="{{ URL::asset("upload_images/categories/icon/$value[id]/$value[icon]")}}" alt="img"></span>
                                                <span class="cat-name ad-cat-text">{{$value['name']}}</span>
                                            </a>
                                        </li>
                            ...
                            <div class="ad-sec-inner">
                                ...
                                <div class="ad-detail-form">
                                    ...
                                    <ul class="ad-detail-form-sec">
                                        ...
                                        <li class="no-ad-padding divCheckBox" iderr="classified_type">
                                            <label>Type Of Classified</label>
                                            <div class="row step3row">
                                                <div class="col-sm-12">
                                                    <ul class="contact-surname">
                                                        <li>
                                                            <input checked="checked" id="classified_type_normal" label_name="classified_type" name="classified_type" class="inputCheckBox" type="radio" is_required="1" value="normal">
                                                            <label for="classified_type_normal">Normal</label>
                                                        </li>
                                                        @if($memPlanUser[0]['is_premium_parent_cat'] == 1 || $memPlanUser[0]['is_premium_sub_cat'] == 1)
                                                        <li>
                                                            <input id="classified_type_premium" label_name="classified_type" name="classified_type" class="inputCheckBox" type="radio" is_required="1" value="premium">
                                                        ...
                                                        <li>
                                                            <input id="classified_type_featured" label_name="classified_type" name="classified_type" class="inputCheckBox" type="radio" is_required="1" value="featured">
                                    ...
                                    <ul class="ad-detail-form-sec">
                                        ...
                                        <li class="no-ad-padding">
                                            <!--<div class="col-sm-8">-->
                                            <input type="file" name="image[]" value="" id="uploadimg_business" class="">
                                            <span class="form-tag-line">require image size 650*375</span> 
                                            <p class="ad-error" id="uploadimg_business_error"></p>
                                            <!--</div>-->
                                        </li>
                                    </ul>
                                ...
                                <div class="ad-detail-form">
                                    ...
                                    <ul class="ad-detail-form-sec ad-data-form-sec">
                                        ...
                                        <li>                       
                                            ...
                                            <span class="form-tag-line use_mycurrent_location">Use my current location</span>
...
<span class="memPlanUser" style="display: none;">{{$memPlanUser->toJson()}}</span>
...
<script src="{{ URL::asset('plugins/front/js/business_post_classified.js') }}"></script>
