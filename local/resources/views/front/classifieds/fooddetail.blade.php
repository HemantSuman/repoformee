                                        ...
                                        <div class="share pull-right post-share">
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu pt-share-icons" role="menu">
                                                    <ul>
                                                        <li>
                                                            <span class='st_facebook_large' displayText='Facebook' st_title='{{ $data->name }}'></span>
                                                        </li>
                                                        <li>
                                ...
                                <div class="MosqueDetail">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="mosque-img">
                                            ...
                                            <img src="{!! asset('/upload_images/food_products/backgroundimage/'.$data->id.'/'.$data->image) !!}" />
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="mosque-info"> 
                                           ...
                                           <ul>
                                            ...
                                            <br />
                                             <ul class="list-features">
                                              ...
                                              <li>
                                                  ...
                                                  <span>
                                                    @foreach($final_ingredient as $key => $value)
                                                 
                                                {{$value['ingredient']}} @if($value['certiificate'] != '') [ {{$value['certiificate']}} ] @endif,
                                                    @endforeach
                                                   </span> 
                                            ...
                                            @if(sizeof($data->food_product_attribute) > 0)
                                            <br/>
