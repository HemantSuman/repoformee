                             ...
                             @if(isset($sensis_results_allschool['results']) && count($sensis_results_allschool['results']) >0)
                              ...
                              <?php if($snum2 > 3) continue; ?>
                                <li>
                                  <label><?php echo $senres['name']?> <span><?php echo number_format($senres['distance'], 3)?> km</span></label>
                                  <?php
                                   if(isset($senres['primaryAddress']['addressLine'])) echo $senres['primaryAddress']['addressLine'];
                                   if(isset($senres['primaryAddress']['suburb'])) echo  ', '.$senres['primaryAddress']['suburb'];
                                   if(isset($senres['primaryAddress']['postcode'])) echo  ' '.$senres['primaryAddress']['postcode'];
                                   ?>
