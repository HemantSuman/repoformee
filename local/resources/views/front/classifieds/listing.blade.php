                                        ...
                                        <div class="search-listing list-view">
                                            <div class="clearfix new-view-design">
                                                ...
                                                <?Php $encodetitle = preg_replace('/[^A-Za-z0-9-]+/', '-', $dataVal['title']);
												 $url = Request::root() . '/classified-detail/'. $encodetitle .'/'. $dataVal->classified_id;
												 ?>
    ...
    <div class="clearfix">
      <div class="col-md-3 col-sm-6 col-xs-6"> <a href="{{ $url }}" class="clearfix">
        <div class="list-img">
          ...
          <img src="{!! asset('/upload_images/classified/'.$dataVal->classified_id.'/'.$dataVal->name) !!}" alt="">
          <span class="tab-badge" title="{!! Helper::time_since(time() - strtotime($dataVal->classified_created)).' ago' !!}">{!! Helper::time_since_for_classified(time() - strtotime($dataVal->classified_created)) !!}</span> </div>
        </a> </div>
    <div class="list-rowContent"> <div class="wishlist-wrap"> @if(in_array($dataVal->classified_id, $wishlistItems)) <a href="javascript:void(0)" class="wishlist-icon active" data-id="{{ $dataVal->classified_id }}">
            <div class="heart"><i class="fa fa-heart"></i> <!--<img src="{{ URL::asset('plugins/front/img/icon-2.png') }}" />--></div>
            </a> @else <a href="javascript:void(0)" class="wishlist-icon" data-id="{{ $dataVal->classified_id }}">
            <div class="heart"> 
      ...
      <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="list-right">
                                                                ...
                                                                <div class="location">
                                                                    @if(!empty($dataVal->location))
                                                                    <?php $expSimLoc = explode(',', trim($dataVal->location)); ?>
                                                                    <span class="classfd-location">{{ $dataVal->city }}</span>
                                                                    @endif

                                                                    <span class="classfd-timeago">{!! Helper::time_since(time() - strtotime($dataVal->classified_created)) !!} ago</span>
                                                                </div>
                                                            </div>
      </div></div>
    </div>
                                                ...
                                                <?php /*?><div class="list-row mosque-row">
                                                    <a href='{{ url("/classified-detail/$encodetitle/$dataVal->classified_id") }}' class="clearfix">
                                                        <div class="col-md-3 col-sm-4 pull-right">
                                                            <div class="list-img">
                                                                            <!-- <img src="assets/img/icons/mosque.png" alt=""> -->
                                                                <img src="{{ URL::asset('upload_images/classified/'.$dataVal->classified_id.'/'.$dataVal->name) }}" alt="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9 col-sm-8">
                                                            <div class="list-data">
                                                                <h3>{{ str_limit($dataVal->title, 28) }}</h3>
                                                                <p>{{ strip_tags(str_limit($dataVal->description, 70)) }}</p>
                                                                @if($dataVal->location)
                                                                <?php $expSimLoc = explode(',', trim($dataVal->location)); ?>
                                                                <span class="msq-location"><img src="{{ url('plugins/front/img/icons/blue-location.png')}}" alt=""> {{ $expSimLoc[1] }}</span>
                                                                @endif
                                                            </div>
                                                        </div>
