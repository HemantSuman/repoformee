            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                   <div class="dashboard-main-detail">
                     ...
                     <div class="dash-notification-sec">
                          <h2>Friday</h2> <a href="#">x</a>
                          <div class="dash-notification-box">
                              <h3><img src="{{ URL:: asset('/plugins/front/img/icons/user.png') }}" alt="img" class="img-responsive"> Billy John <span>Fri 6:08 pm</span></h3>
                              <p>Billy John has recently purchased a Samsung Galaxy S8 Black. </p>
                              <div class="notify-thumb">
                                  <img src="{{ URL:: asset('/plugins/front/img/noti-thumb.jpg') }}" alt="img" class="img-responsive">  
                              </div>
                          </div>
                          <div class="dash-notification-box">
                              <h3><img src="{{ URL:: asset('/plugins/front/img/icons/user.png') }}" alt="img" class="img-responsive"> Kimberly James <span>Fri 6:08 pm</span></h3>
                              <p>Kimberly James has recently purchased a Samsung Galaxy S8 Black. </p>
                              <div class="notify-thumb">
                                  <img src="{{ URL:: asset('/plugins/front/img/noti-thumb.jpg') }}" alt="img" class="img-responsive">  
                              </div>
                          </div>
                     ...
                     <div class="dash-notification-sec">
                          <h2>Thursday</h2> <a href="#">x</a>
                          <div class="dash-notification-box">
                              <h3><img src="{{ URL:: asset('/plugins/front/img/icons/user.png') }}" alt="img"> Billy John <span>Fri 6:08 pm</span></h3>
                              <p>Billy John has recently purchased a Samsung Galaxy S8 Black. </p>
                              <div class="notify-thumb">
                                  <img src="{{ URL:: asset('/plugins/front/img/noti-thumb.jpg') }}" alt="img">  
                              </div>
                          </div>
                          <div class="dash-notification-box">
                              <h3><img src="{{ URL:: asset('/plugins/front/img/icons/user.png') }}" alt="img"> Kimberly James <span>Fri 6:08 pm</span></h3>
                              <p>Kimberly James has recently purchased a Samsung Galaxy S8 Black. </p>
                              <div class="notify-thumb">
                                  <img src="{{ URL:: asset('/plugins/front/img/noti-thumb.jpg') }}" alt="img">  
                              </div>
