                                    ...
                                    <div class="col-sm-10">
                                        <div class="proData">
                                            ...
                                            <div class="proDatainner">
                                                ...
                                                <div class="row profileRow">
                                                    <div class="col-md-6 col-sm-6">
                                                      <label> PayPal Profile ID:</label>
                                                      <p> {{ $pp_profile_response['PROFILEID'] }}</p>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                      <label> PayPal Profile Status:</label>
                                                      <p> {{ $pp_profile_response['STATUS'] }}</p>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                      <label> PayPal Amount:</label>
                                                      <p> ${{ $pp_profile_response['AMT'] }}</p>
                                                    </div>
                                                    <?php 
													if($pp_profile_response['STATUS']=='ActiveProfile' || $pp_profile_response['STATUS']=='Active'){?>
                                                    <div class="col-md-6 col-sm-6">
                                                      <label> Profile Start Date:</label>
                                                      <p> {{ $pp_profile_response['PROFILESTARTDATE'] }}</p>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                      <label> Profile Next Billing Date:</label>
                                                      <p> {{ $pp_profile_response['NEXTBILLINGDATE'] }}</p>
                                                    </div>
                                                    <?php } ?>
                                                ...
                                                <div class="row profileRow">
                                                 ...
                                                 {!! Form::open(array("url" => "user/cancel-pp-profile", "role" => "form", 'id' => 'update-pp-form', 'novalidate')) !!}
