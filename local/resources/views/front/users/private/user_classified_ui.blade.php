                ...
                <div class="col-md-5 col-sm-5 col-xs-6">
                    <div class="msgRight">
                        ...
                        <span class="price">${{ $uacVal['price'] }}</span>
                         ...
                         <?php
							$cat_id = $uacVal['category_id'] ;
							if($cat_id != '0' && $cat_id != ''){
							$salablecat = DB::table('categories')->select('is_sellable')->where(['id' => $cat_id])->orderBy('id', 'desc')->first();
							$is_sellable = $salablecat->is_sellable;
							//echo $is_sellable;
							if($is_sellable){ //check merchant AD
							?>
                            <span class="adpostPvt"><a href='{{ url("/user/sales/$uacVal[id]") }}' > View Orders </a> </span>
                            <?php
							}else{ 
                            	$parent_cat_id = $uacVal['parent_categoryid'] ;
                            if($parent_cat_id == '37'){ //for JOB Ads
                            ?>
                            <span class="adpostPvt"><a href='{{ url("/user/jobapplications/$uacVal[id]") }}'> View Job Applications </a></span>
                            <?php
							}
							} 
