...
<tr>
	...
	<?php if(!empty($userdata['password'])){?>
        <p style="margin:0;width:250px;font-size:18px;text-decoration:none;display:block;padding:12px;border:1px solid #5193e2;color:#fff;text-align:center;border-radius:3px;background:#5ca6ff" > Your Password:- <?php echo $userdata['password'] ?> </p>
	<br/>
        <?php }?>
