                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;" valign="top">
                                    ...
                                    <br />
                                    <p>The following Ad (<a href="<?php echo Request::root().'/classifieds/'.$dataSendInMail->id; ?>" style="text-decoration: underline; color: inherit;">{{ Request::root().'/classifieds/'.$dataSendInMail->id }}</a>) posted by you has been activated.</p>
                                    <br/>
                                    Classified details as follow : <br/><br/>
