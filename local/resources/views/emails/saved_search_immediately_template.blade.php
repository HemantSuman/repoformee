              ...
              <tr>
                <td align="center" valign="top" style="padding-top:15px;">
                  <table width="100%" bgcolor="#ef4b23" border="0" cellpadding="0" cellspacing="0" align="center">  
                    <tr>
                      <?php
                      switch ($mailDetails["svd_srch_dtl"]["email_frequency"]) {
                        case "1":
                     ...
                     <tr>
                      <td style=" font-family:'Roboto', sans-serif; font-size:32px;color:#fff;  font-weight:bold;text-align:center; padding-top:15px; padding-bottom:15px;" class="midtxt2"><p style="margin:0">{{ $mailDetails["saved_srch_name"] }} {{ !empty($mailDetails["svd_srch_dtl"]['usr_state']) ? " in ".$mailDetails["svd_srch_dtl"]['usr_state'] : "" }}</p></td>
                    </tr>
                    <tr>
                      <?php
                        $qryParamsArray = array(
                          'itemname' => $mailDetails["svd_srch_dtl"]['keyword'],
                          'city' => $mailDetails["svd_srch_dtl"]['city'],
                          'lat' => $mailDetails["svd_srch_dtl"]['lat'],
                          'lng' => $mailDetails["svd_srch_dtl"]['lng'],
                          'usr_state' => $mailDetails["svd_srch_dtl"]['usr_state'],
                          'usr_city' => $mailDetails["svd_srch_dtl"]['usr_city'],
                          'usr_pcode' => $mailDetails["svd_srch_dtl"]['usr_pcode'],
                          'km' => $mailDetails["svd_srch_dtl"]['distance'],
                          'cat_id' => $mailDetails["svd_srch_dtl"]['category_id'],
                        );
                      ?>
                  ...
                  <table width="95%" align="center"  cellpadding="0" cellspacing="0" style="";>
                    <tr>
                      <td class="" style="padding-top:8px; padding-bottom:8px; padding-left:0px; padding-right:10px;" valign="top">
                        ...
                        <a href="{{ url('/classifieds/'.$mailDetails['classified_data']['id']) }}">
                        <div class="catimg"><img src="{!! asset('/upload_images/classified/285x217px/'.$mailDetails['classified_data']['id'].'/'.$mailDetails['classified_data']['classified_image'][0]['name']) !!}" style="width:100%; height:auto"></div>
                        </a>
                        <div class="CatName" style="font-family:'Roboto', sans-serif; font-size:22px;color:#000000;  font-weight:bold; padding-top:3px;text-align:center">{{$mailDetails["classified_data"]["title"]}}</div>
                        <div class="locat" style=" font-family:'Roboto', sans-serif; font-size:20px;color:#4d4d4d;  font-weight:300; padding-top:5px;text-align:center">{{$mailDetails["classified_data"]["location"]}}</div>
                        <div class="time" style=" font-family:'Roboto', sans-serif; font-size:18px;color:#4d4d4d;  font-weight:bold;text-align:center; padding-bottom:5px;">{{ date("d M", strtotime($mailDetails["classified_data"]['created_at'])) }}</div>
                        </div>
                      </td>
                    </tr>
                  </table>
