                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;" valign="top">
                                    <p>A query has been posted by the user. </p>
                                    <br/>
                                    Details as follows : <br/><br/>
                                    <ul>
                                        <li>Name : {{ $mailingData['name'] }}</li>
                                        <li>Email : {{ $mailingData['email'] }}</li>
                                        <li>Type : {{ ($mailingData['email'] == "inbox" ? "Inbox Query" : "Support Query") }}</li>
                                        <li>Query : {{ $mailingData['contact_query'] }}</li>
                                    </ul>
                                </td>
