                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;" valign="top">
                                    <p>Thankyou for your Order on Formee. Here is your Order details below:</p>
                                    <br/>
                                    <br/><br/>
                                    <table cellpadding="0" cellspacing="0">
                                    <tr>
                                    ...
                                    <?php /*?><td>Shipping Method/Cost</td><?php */?>
                                    <td>Seller Name</td>
                                    </tr>
                                    <?php
									$GrandTotal = 0;
                                    ...
                                    <td>${{ $value->item_total_amt }} </td>
                                    <?php /*?><td>{{ $value->item_ship_name }} / ${{ $value->item_ship_cost }}</td><?php */?>
                                    ...
                                    <?php
									$GrandTotal += $value->item_total_amt ;
									?>
                                    @endforeach
                                    <tr>
                                    <td colspan="2">&nbsp;</td>
